...
INSERT INTO `students` (`firstname`, `lastname`, `class`, `device`, `email`) VALUES
('Nynne', 'Hirksholm', '1a', '3242480324', 'e@mail.com');
...
INSERT INTO `repairs` (`device`, `owner`, `ticketid`, `status`) VALUES
...
INSERT INTO `devicehistory`(`email`, `device`, `startdate`, `enddate`) VALUES
